...
const predefinedFoods = [
  { name: 'Apple', calories: 52, carbs: 14, fats: 0.2, protein: 0.3, sodium: 1, sugar: 10, cholesterol: 0 },
  { name: 'Banana', calories: 89, carbs: 23, fats: 0.3, protein: 1.1, sodium: 1, sugar: 12, cholesterol: 0 },
  { name: 'Chicken Breast', calories: 165, carbs: 0, fats: 3.6, protein: 31, sodium: 74, sugar: 0, cholesterol: 85 },
  { name: 'Rice', calories: 130, carbs: 28, fats: 0.3, protein: 2.7, sodium: 1, sugar: 0, cholesterol: 0 },
  { name: 'Broccoli', calories: 55, carbs: 11, fats: 0.6, protein: 4.2, sodium: 33, sugar: 2.2, cholesterol: 0 },
  { name: 'Egg', calories: 68, carbs: 0.4, fats: 4.8, protein: 6, sodium: 62, sugar: 0.4, cholesterol: 186 },
  { name: 'Salmon', calories: 208, carbs: 0, fats: 13, protein: 22, sodium: 63, sugar: 0, cholesterol: 63 },
  { name: 'Avocado', calories: 160, carbs: 9, fats: 15, protein: 2, sodium: 7, sugar: 0.2, cholesterol: 0 },
  { name: 'Carrot', calories: 41, carbs: 10, fats: 0.2, protein: 0.9, sodium: 69, sugar: 4.7, cholesterol: 0 },
  { name: 'Yogurt', calories: 59, carbs: 7.7, fats: 3.3, protein: 3.5, sodium: 46, sugar: 4.7, cholesterol: 10 },
];
...
{['breakfast', 'lunch', 'dinner', 'snacks'].map((meal) => (
  <div key={meal}>
    ...
    <button
      ...
      className="bg-green-500 text-white px-4 py-2 rounded mt-2 hover:bg-green-600 transition-all"
    >
