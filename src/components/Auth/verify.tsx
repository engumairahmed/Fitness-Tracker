                ...
                .catch(
                    err => {
                        ...
                        if (err.response && err.response.data) {
                            ...
                            formik.setErrors(serverErrors); // Dynamically set errors
                        } else {
                    ...
                    >
                        <motion.div whileHover={{ scale: 1.05 }} className="relative mt-2">
                            ...
                            <input
                                ...
                                className={`block w-full border-gray-300 py-4 pl-10 pr-3 text-gray-900 placeholder-gray-400 shadow-sm focus:outline-none sm:text-sm bg-gray-100 ${formik.touched.email && formik.errors.email
                                        ? "border-red-500"
                                        : ""
                                    }`}
